...
## BUTTON SETUP
Raw button values will be displayed in top left corner of menu screen. Calibrate your button values in button.c according the the values displayed on screen.
